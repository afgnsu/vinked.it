      ...
      file.each do |line|
        if counter > 0
          ...
          unless new_club_home.blank? || new_club_away.blank?
            visit.visit_nr = attributes[13]
            visit.the92_nr = attributes[14]
            visit.visit_date = attributes[1]
            visit.ground = attributes[10]
            visit.address = attributes[11].gsub(/"/, '')
            visit.latitude = attributes[17]
            visit.longitude = attributes[18]
            visit.gmaps = attributes[19]
            visit.result = attributes[3].gsub /"/, ''
            visit.season = attributes[4].gsub /"/, ''
            visit.kickoff = attributes[5].gsub /"/, ''
            visit.gate = attributes[6]
            visit.ticket_price = attributes[7]
            visit.countfor92 = attributes[9]
            visit.rating_match = attributes[23]
            visit.rating_ground = attributes[24]
            visit.rating_atmosphere = attributes[25]
            visit.rating_average = ((attributes[23].to_i+attributes[24].to_i+attributes[25].to_i)/3).to_f
            visit.programme = attributes[20].gsub /"/, ''
            visit.ticket = attributes[21].gsub /"/, ''
            visit.rating_match = attributes[23]
            ...
            visit.photo1 = attributes[27].gsub /"/, ''
            visit.photo2 = attributes[29].gsub /"/, ''
            visit.photo3 = attributes[29].gsub /"/, ''
            visit.photo4 = attributes[31].gsub /"/, ''
            visit.user_id = 1
